...
% - Default model initial conditions are used to initialize optimization.
if Phi_deg ~= 0
    opspec.States(21).SteadyState = false;
else
    opspec.States(21).SteadyState = true;
end
...
% - Default model initial conditions are used to initialize optimization.
opspec.States(16).SteadyState = false;

% State (11) - ACFT/EqM/InertialData/YI_m1
% - Default model initial conditions are used to initialize optimization.
opspec.States(17).SteadyState = false;

% State (12) - ACFT/EqM/InertialData/ZI_m
% - Default model initial conditions are used to initialize optimization.
opspec.States(18).SteadyState = false;
...
% - Default model initial conditions are used to initialize optimization.
opspec.Inputs(8).Min = -40;
opspec.Inputs(8).Max = 40;
...
if Throttle~=-1;
opspec.Inputs(9).u = Throttle;
opspec.Inputs(9).Min = 0;
opspec.Inputs(9).Max = 1;
opspec.Inputs(9).Known = true;
else
opspec.Inputs(9).Min = 0;
opspec.Inputs(9).Max = 1;
opspec.Inputs(9).Known = false;
end
...
opspec.Outputs(19).y = Phi_deg;
opspec.Outputs(19).Known = true;
...
% - Default model initial conditions are used to initialize optimization.
if Throttle~=-1;
opspec.Outputs(14).Known = false;
else
    opspec.Outputs(14).Known = true;
    opspec.Outputs(14).y = Gamma_deg;
end
